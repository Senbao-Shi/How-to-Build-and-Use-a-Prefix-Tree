...
class Trie(object):
    ...
    def get(self, prefix_sequence: List[int]):
        ...
        prefix_sequence_ = [] # you can set breakpoint here to check the prefix sequence, [2, ..., 2]
        for i in range(len(prefix_sequence) - 1, -1, -1):
            if prefix_sequence[i] == self.bos_token_id: # start with bos token! 2
                prefix_sequence_ = prefix_sequence[i:] # [2, generated tokens]
                break
